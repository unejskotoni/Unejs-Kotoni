...
I am an IT Computer Networking student with a focus on **Cybersecurity** and **Network Infrastructure**. I specialize in building secure systems, automating network tasks, and applying security-first principles to development projects.

### 🛠 Technical Skills
* **Networking:** TCP/IP, VPN configuration, Firewall management, DNS/DHCP.
* **Cybersecurity:** Penetration Testing, Vulnerability Assessment, CIA Triad implementation.
* **Scripting/Languages:** Python, Bash, SQL.
* **Tools:** Wireshark, Nmap, Git, Linux/Windows Server environments.
...
🔐 Cyber & Security: Cloudflare WAF & Turnstile (Bot protection, DDoS mitigation, and spam prevention)

### 📬 Let's Connect
* **LinkedIn:** www.linkedin.com/in/unejs-kotoni-918380419
* **Email:** unejskotoni@gmail.com
